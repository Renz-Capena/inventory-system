<?php
    ...
    $q = "UPDATE `schools` SET `school_name`='$schoolName',`school_id`='$schoolID',`division`='$division',`school_type`='$schoolType',`contact_person`='$contactPerson',`contact_no`='$contactNo',`email`='$email',`district`='$district' WHERE id='$id'";
